...
- Feature file is at: `karate-tests/karate-test/Country/country_id_delete.feature`
- Config directory: `karate-tests/config`

Then run the command:

```bash
java -Dkarate.config.dir=karate-tests/config -jar Downloads/karate-1.5.1.jar karate-tests/karate-test/Country/country_id_delete.feature
```
...
- Console shows the execution result
- Reports are saved in: `karate-reports/karate-summary.html`
