...
1. Suppose:
   ...
   - Your feature file is located at /var/tmp/Roost/RoostGPT/karate-test/1752577743/source/node-telegram-bot-api/karate-tests/Country/country_get/country_get.feature.
   - Your 'karate-config.js' configuration file is in 'karate-tests/config'.

2. Run the feature file using the following command:


java -Dkarate.config.dir=karate-tests/config -jar /var/tmp/Roost/bin/karate-1.5.1.jar /var/tmp/Roost/RoostGPT/karate-test/1752577743/source/node-telegram-bot-api/karate-tests/Country/country_get/country_get.feature
