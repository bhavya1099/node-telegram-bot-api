...
1. Suppose:
   ...
   - Your feature file is located at /var/tmp/Roost/RoostGPT/karate-test/1752577213/source/node-telegram-bot-api/karate-tests/Country/country_id_get/country_id_get.feature.
   - Your 'karate-config.js' configuration file is in 'karate-tests/config'.

2. Run the feature file using the following command:


java -Dkarate.config.dir=karate-tests/config -jar <karate_jar_filepaht> /var/tmp/Roost/RoostGPT/karate-test/1752577213/source/node-telegram-bot-api/karate-tests/Country/country_id_get/country_id_get.feature
