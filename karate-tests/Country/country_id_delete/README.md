...
4. **Configuration Directory**: Optional — if you have custom configurations, you can specify the directory where your 'karate-config.js' file exists.
...
- **<karate jar file>**: Path to the Karate JAR file.
...
1. Suppose:
   - Your Karate JAR file is at 'C:	oolskarate.jar'.
   - Your feature file is located at /var/tmp/Roost/RoostGPT/karate-test/1752577213/source/node-telegram-bot-api/karate-tests/Country/country_id_delete/country_id_delete.feature.
   - Your 'karate-config.js' configuration file is in 'karate-tests/config'.

2. Run the feature file using the following command:


java -Dkarate.config.dir=karate-tests/config -jar <karate_jar_filepaht> /var/tmp/Roost/RoostGPT/karate-test/1752577213/source/node-telegram-bot-api/karate-tests/Country/country_id_delete/country_id_delete.feature
